...
class TestS49ARunnerFallbackOnIter0:
    ...
    async def test_iter0_with_tool_calls_does_not_call_runner(self, tmp_path):
        ...
        first_response.tool_calls = [
            {
                "name": "write_file",
                "args": {"path": "src/main.py", "content": "def hello(): pass"},
                "id": "tc1",
            }
        ]
        ...
        assert not runner_called, (
            "El runner NO debe haber sido llamado cuando hay tool_calls en iter 0"
        )
...
class TestS49BSddTaskLimit:
    def test_sdd_template_says_max_5_tasks(self):
        ...
        assert (
            "5 tareas" in content
            or "MÁXIMO 5" in content
            or "máximo 5" in content.lower()
        )
    ...
    def test_sdd_template_mentions_performance_reason(self):
        ...
        assert (
            "minutos" in content or "minuto" in content or "overhead" in content.lower()
        )
