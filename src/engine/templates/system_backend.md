...
GET /contratos/{rut}
GET /contratos/vencimientos   ← nunca se alcanza

# ✅ CORRECTO — específica primero:
GET /contratos/vencimientos   ← estática primero
GET /contratos/{rut}          ← paramétrica después
```

Si el stack es Python, ver `backend_python.md` para las reglas D2 (ORM/schemas) y D3 (datetime agnóstico).
